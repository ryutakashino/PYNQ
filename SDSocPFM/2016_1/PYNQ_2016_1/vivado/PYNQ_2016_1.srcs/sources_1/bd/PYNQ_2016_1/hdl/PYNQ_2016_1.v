...
//Date        : Mon Mar 27 10:23:48 2017
//Host        : bluesurface running 64-bit major release  (build 9200)
//Command     : generate_target PYNQ_2016_1.bd
//Design      : PYNQ_2016_1
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "PYNQ_2016_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=PYNQ_2016_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "PYNQ_2016_1.hwdef" *) 
module PYNQ_2016_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  PYNQ_2016_1_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
        .ext_reset_in(ps7_FCLK_RESET0_N),
        .mb_debug_sys_rst(1'b0),
        .slowest_sync_clk(ps7_FCLK_CLK0));
  PYNQ_2016_1_proc_sys_reset_0_1 proc_sys_reset_1
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
        .ext_reset_in(ps7_FCLK_RESET0_N),
        .mb_debug_sys_rst(1'b0),
        .slowest_sync_clk(ps7_FCLK_CLK1));
  PYNQ_2016_1_proc_sys_reset_0_2 proc_sys_reset_2
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
        .ext_reset_in(ps7_FCLK_RESET0_N),
        .mb_debug_sys_rst(1'b0),
        .slowest_sync_clk(ps7_FCLK_CLK2));
  PYNQ_2016_1_proc_sys_reset_0_3 proc_sys_reset_3
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
        .ext_reset_in(ps7_FCLK_RESET0_N),
        .mb_debug_sys_rst(1'b0),
        .slowest_sync_clk(ps7_FCLK_CLK3));
  PYNQ_2016_1_processing_system7_0_0 ps7
  ...
  PYNQ_2016_1_xlconcat_0_0 xlconcat_0
       (.In0(1'b0),
