...
################################################################
# This is a generated script based on design: PYNQ_2016_1
#
...
CONFIG.NUM_PORTS {1} \
  ...
  connect_bd_intf_net -intf_net dm_0_M_AXIS_MM2S [get_bd_intf_pins dm_0/M_AXIS_MM2S] [get_bd_intf_pins mmult_accel_0_if/S_AXIS_0]
  ...
  connect_bd_intf_net -intf_net dm_1_M_AXIS_MM2S [get_bd_intf_pins dm_1/M_AXIS_MM2S] [get_bd_intf_pins mmult_accel_0_if/S_AXIS_1]
  ...
  connect_bd_intf_net -intf_net mmult_accel_0_A [get_bd_intf_pins mmult_accel_0/A] [get_bd_intf_pins mmult_accel_0_if/AP_FIFO_IARG_0]
  connect_bd_intf_net -intf_net mmult_accel_0_B [get_bd_intf_pins mmult_accel_0/B] [get_bd_intf_pins mmult_accel_0_if/AP_FIFO_IARG_1]
  connect_bd_intf_net -intf_net mmult_accel_0_C [get_bd_intf_pins mmult_accel_0/C] [get_bd_intf_pins mmult_accel_0_if/AP_FIFO_OARG_0]
  ...
  connect_bd_net -net ps7_FCLK_CLK1 [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps7/FCLK_CLK1]
  ...
  connect_bd_net -net ps7_FCLK_CLK3 [get_bd_pins proc_sys_reset_3/slowest_sync_clk] [get_bd_pins ps7/FCLK_CLK3]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs mmult_accel_0_if/S_AXI/Reg] SEG_mmult_accel_0_if_Reg
...
preplace inst ps7 -pg 1 -lvl 2 -y 50 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 3 -y -250 -defaultsOSRD
preplace inst proc_sys_reset_1 -pg 1 -lvl 3 -y -90 -defaultsOSRD
preplace inst xlconcat -pg 1 -lvl 1 -y 50 -defaultsOSRD
preplace inst proc_sys_reset_2 -pg 1 -lvl 3 -y 100 -defaultsOSRD
preplace inst proc_sys_reset_3 -pg 1 -lvl 3 -y 260 -defaultsOSRD
preplace netloc ps7_FIXED_IO 1 2 2 NJ 10 920
preplace netloc ps7_FCLK_CLK0 1 2 1 540
preplace netloc ps7_FCLK_CLK1 1 2 1 560
preplace netloc ps7_DDR 1 2 2 NJ 0 910
preplace netloc xlconcat_0_dout 1 1 1 N
preplace netloc ps7_FCLK_CLK2 1 2 1 570
preplace netloc ps7_FCLK_CLK3 1 2 1 550
preplace netloc ps7_FCLK_RESET0_N 1 2 1 580
levelinfo -pg 1 0 100 370 750 940 -top -330 -bot 370
",
}
